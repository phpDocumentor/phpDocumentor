...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:include href="../default/search.xsl" />
  ...
  <xsl:template match="package">
    <li class="closed">
      ...
      <ul id="packages_{$package}" class=".filetree">
        <xsl:for-each select="/project/file/class[docblock/tag[@name='package'][.=$package]|/project/file/interface[docblock/tag[@name='package'][.=$package] and not(docblock/tag[@name='subpackage'])]">
          <li class="closed">
            <span class="file">
              <a href="{$root}{../@generated-path}#{name}" target="content">
                <xsl:value-of select="name" />
        ...
        <xsl:for-each select="subpackage">
          ...
          <ul id="packages_{$package}_{$subpackage}" class="treeview-docblox">
            <xsl:for-each select="/project/file/class[docblock/tag[@name='package'][.=$package]|/project/file/interface[docblock/tag[@name='package'][.=$package] and docblock/tag[@name='subpackage'][.=$subpackage]]">
            <li class="file">
              <span>
                <a href="{$root}{../@generated-path}#{name}" target="content">
                  <xsl:value-of select="name" />
