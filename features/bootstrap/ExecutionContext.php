...
class ExecutionContext extends BehatContext
{
    ...
    {
        $this->iRun("php bin/phpdoc.php -t /tmp/phpdoc-behat --config=none --force");
    }
    ...
    {
        $this->iRun(
            "php bin/phpdoc.php -f $file_path -t /tmp/phpdoc-behat --config=none --force"
        );
    }
    ...
    public function iRunPhpDocumentorWith(PyStringNode $code, $extraParameters = '')
    {
        ...
        $this->iRun("php bin/phpdoc.php -f $file -t /tmp/phpdoc-behat --config=none --force $extraParameters");
        unlink($file);
    }
    ...
    {
        $this->iRun(
            "php bin/phpdoc.php -f $file_path -t /tmp/phpdoc-behat --config=none "
            ."--force $options"
        );
    }
    ...
    {
        $this->iRun(
            "php bin/phpdoc.php -d $folder_path -t /tmp/phpdoc-behat --config=none --force"
        );
    }
