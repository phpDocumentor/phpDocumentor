Feature: Validate whether my DocBlocks are valid
  ...
  @todo split into multiple scenarios
  Scenario: Show an error when DocBlocks are missing a Short Description.
    ...
    Then I should get a log entry "No summary was found for this file"
    Then I should get a log entry "No summary for class \NoShortDescription"
    Then I should get a log entry "No summary for property $_noShortDescriptionProperty"
    Then I should get a log entry "No summary for method noShortDescriptionFound()"
