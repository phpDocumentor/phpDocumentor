...
class DocBlox_Reflection_DocBlock implements Reflector
{
    ...
    /**
     * @var DocBlox_Reflection_DocBlock_LongDescription The actual description
     *     for this docblock.
     */
    protected $long_description = null;

    /**
     * @var DocBlox_Reflection_DocBlock_Tags[] An array containing all the tags
    ...
    public function __construct($docblock)
    {
        ...
        $this->long_description = new DocBlox_Reflection_DocBlock_LongDescription(
            $long
        );
        $this->parseTags($tags);
    }
    ...
    protected function parseTags($tags)
    {
        ...
        foreach ($result as $key => $tag_line) {
            $result[$key] = DocBlox_Reflection_DocBlock_Tag::createInstance(
                $tag_line
            );
        }
