...
class DocBlox_GraphViz_Graph
{
    ...
    /** @var DocBlox_GraphViz_Attribute[] A list of attributes for this Graph */
    protected $attributes = array();

    /** @var DocBlox_GraphViz_Graph[] A list of subgraphs for this Graph */
    protected $graphs = array();

    /** @var DocBlox_GraphViz_Node[] A list of nodes for this Graph */
    protected $nodes = array();

    /** @var DocBlox_GraphViz_Edge[] A list of edges / arrows for this Graph */
     ...
     * @return DocBlox_GraphViz_Graph
     */
    public function addGraph(DocBlox_GraphViz_Graph $graph)
    {
     ...
     * @return DocBlox_GraphViz_Graph
     */
    public function setNode(DocBlox_GraphViz_Node $node)
    {
     ...
     * @return DocBlox_GraphViz_Graph
     */
    public function link(DocBlox_GraphViz_Edge $edge)
    {
        $this->edges[] = $edge;
        return $this;
    }
