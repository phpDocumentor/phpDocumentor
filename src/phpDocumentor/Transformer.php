 ...
 * @link     http://phpdoc.org
 */
class phpDocumentor_Transformer extends phpDocumentor_Transformer_Abstract
{
    ...
    /** @var phpDocumentor_Transformer_Template[] */
    protected $templates = array();

    /** @var string */
    protected $templates_path = '';

    /** @var phpDocumentor_Transformer_Behaviour_Collection */
    ...
    public function addTemplate($name)
    {
        ...
        $this->templates[$name] = new phpDocumentor_Transformer_Template($name, $path);
