 ...
 * @link     http://phpdoc.org
 */
class phpDocumentor_Reflection_DocBlock implements Reflector
{
    /** @var string The opening line for this docblock. */
    protected $short_description = '';

    /**
     * @var phpDocumentor_Reflection_DocBlock_LongDescription The actual description
     *     for this docblock.
     */
    protected $long_description = null;

    /**
     * @var phpDocumentor_Reflection_DocBlock_Tags[] An array containing all the tags
     ...
     *
     * @throws phpDocumentor_Reflection_Exception
     */
    public function __construct($docblock)
    {
        ...
        $this->long_description = new phpDocumentor_Reflection_DocBlock_LongDescription(
            $long
        );
        $this->parseTags($tags);
    }
    ...
    protected function parseTags($tags)
    {
        ...
        foreach ($result as $key => $tag_line) {
            $result[$key] = phpDocumentor_Reflection_DocBlock_Tag::createInstance(
                $tag_line
            );
        }
     ...
     *
     * @return phpDocumentor_Reflection_DocBlock_LongDescription
     */
     ...
     *
     * @return phpDocumentor_Reflection_DocBlock_Tags[]
     */
     ...
     *
     * @return phpDocumentor_Reflection_DocBlock_Tag[]
     */
    public function getTagsByName($name)
    {
        $result = array();

        /** @var phpDocumentor_Reflection_DocBlock_Tag $tag */
