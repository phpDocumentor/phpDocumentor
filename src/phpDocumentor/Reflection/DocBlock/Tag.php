 ...
 * @link     http://phpdoc.org
 */
class phpDocumentor_Reflection_DocBlock_Tag implements Reflector
{
    ...
    /** @var phpDocumentor_Reflection_DocBlockedAbstract docblock class */
    protected $docblock;
    ...
    public static function createInstance($tag_line)
    {
        ...
        $class_name = 'phpDocumentor_Reflection_DocBlock_Tag_' . $tag_name;
     ...
     *
     * @param phpDocumentor_Reflection_DocBlockedAbstract $docblock DocBlock class
     *
     * @return void
     */
    public function setDocBlock(phpDocumentor_Reflection_DocBlockedAbstract $docblock)
    {
