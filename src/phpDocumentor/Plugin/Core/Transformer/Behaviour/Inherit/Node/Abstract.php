 ...
 * @link       http://phpdoc.org
 */
abstract class phpDocumentor_Plugin_Core_Transformer_Behaviour_Inherit_Node_Abstract
{
    /** @var DOMElement */
    protected $node = null;
     ...
     * @param phpDocumentor_Plugin_Core_Transformer_Behaviour_Inherit_Node_Class[] &$nodes
     ...
     * this one.
     *
     * @param phpDocumentor_Plugin_Core_Transformer_Behaviour_Inherit_Node_Abstract
     ...
     * be added.
     *
     * @return phpDocumentor_Plugin_Core_Transformer_Behaviour_Inherit_Node_DocBlock
     */
    public function getDocBlock()
    {
        ...
        return new phpDocumentor_Plugin_Core_Transformer_Behaviour_Inherit_Node_DocBlock(
            $docblock, $this->nodes
        );
    }
}