 ...
 * @link       http://phpdoc.org
 */
class phpDocumentor_Plugin_Core_Parser_DocBlock_Tag_Definition
    extends phpDocumentor_Parser_Abstract
{
     ...
     * plugin system.
     *
     * @return phpDocumentor_Parser_DocBlock_Tag_Definition
     */
    public static function create(
        ...
        case 'property':
        case 'param':
            $def = new phpDocumentor_Plugin_Core_Parser_DocBlock_Tag_Definition_Param(
                $namespace, $namespace_aliases, $xml, $tag
            );
            break;
        case 'see':
            $def = new phpDocumentor_Plugin_Core_Parser_DocBlock_Tag_Definition_See(
                $namespace, $namespace_aliases, $xml, $tag
            );
            break;
        case 'method':
            $def = new phpDocumentor_Plugin_Core_Parser_DocBlock_Tag_Definition_Method(
                $namespace, $namespace_aliases, $xml, $tag
            );
            break;
        case 'uses':
            $def = new phpDocumentor_Plugin_Core_Parser_DocBlock_Tag_Definition_Uses(
                $namespace, $namespace_aliases, $xml, $tag
            );
            break;
        case 'link':
        ...
        case 'Version':
            $def = new phpDocumentor_Plugin_Core_Parser_DocBlock_Tag_Definition_Doctrine(
                $namespace, $namespace_aliases, $xml, $tag
            );
            break;
        default:
