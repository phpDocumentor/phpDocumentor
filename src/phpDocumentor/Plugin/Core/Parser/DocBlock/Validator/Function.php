<?php
/**
 * File contains the phpDocumentor_Core_Validator_Function class
 *
 * PHP Version 5
 *
 ...
 * @link       http://phpdoc.org
 */
class phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Function
    extends phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Abstract
{
    ...
    protected function hasDocBlock()
    {
        ...
        $this->logParserError(
            'ERROR',
            $this instanceof phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Method
                ? 50010
                : 50009,
            $this->lineNumber,
