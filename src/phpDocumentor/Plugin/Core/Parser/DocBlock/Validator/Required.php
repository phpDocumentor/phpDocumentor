<?php
/**
 * File contains the phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Required class
 *
 * PHP Version 5
 *
 ...
 * @link       http://phpdoc.org
 */
class phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Required
