...
use phpDocumentor\Plugin\Standards\Ruleset as BaseRuleset;
...
{
    /**
     * Creates the phpDocumentor Documentation Standard and populates it will all the rules, and their messages.
     */
    public function __construct()
    {
        parent::__construct('phpDocumentor');
