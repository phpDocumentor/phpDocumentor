 ...
 * @link     http://phpdoc.org
 */
class phpDocumentor_Parser extends phpDocumentor_Parser_Abstract
{
    ...
    /** @var phpDocumentor_Parser_Exporter_Abstract */
    ...
    public function parseFiles(phpDocumentor_Parser_Files $files, $include_source = false)
    {
        ...
        if (count($paths) < 1) {
            throw new phpDocumentor_Parser_Exception(
                'No files were found',
                phpDocumentor_Parser_Exception::NO_FILES_FOUND
            );
        }
