...
final class AutoloaderLocator
{
     ...
     *
     * If composer uses a custom composer.json filename with COMPOSER environment variable or a custom vendor directory
     * name with COMPOSER_VENDOR_DIR or with a 'vendor-dir' entry in composer.json, the vendor folder won't be
     * named 'vendor' so we base the matching on the presence of the autoload.php file generated by composer during
     * install.
     *
     * @see https://getcomposer.org/doc/03-cli.md#composer
     * @see https://getcomposer.org/doc/03-cli.md#composer-vendor-dir
     * 
