...
/**
 * Class FileTest
 * @coversDefaultClass phpDocumentor\Application\ReadModel\Mappers\Project\FileInterfaces
 */
class FileInterfacesTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers ::__invoke()
     * @covers ::convertItems()
    ...
    public function testInterpretThisCommand()
    {
        ...
        $fileInterfaces = new FileInterfaces();

        $state = $fileInterfaces($command, null);

        $expectedState = ['interfaces' => ['MyInterface' => null]];
