...
/**
* Test class for DocBlox_Config.
*/
class DocBlox_ConfigTest extends PHPUnit_Framework_TestCase
{
  /** @var DocBlox_Config */
  ...
  {
    $this->fixture = new DocBlox_Config('<?xml version="1.0"?><docblox></docblox>');
  }
  ...
  public function testConstruct()
  {
    ...
    $this->assertTrue(isset($this->fixture->templates->default));
  }
