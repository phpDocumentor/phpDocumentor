 ...
 * @link       http://phpdoc.org
 */
class phpDocumentor_Parser_AbstractMock extends phpDocumentor_Parser_Abstract
{

}

/**
 * Test for the Layer superclass in the phpDocumentor_Parser Component.
 *
 * @category   phpDocumentor
 * @package    Parser
 * @subpackage Tests
 ...
 * @link       http://phpdoc.org
 */
class phpDocumentor_Parser_AbstractTest extends PHPUnit_Framework_TestCase
{
    /** @var phpDocumentor_Parser_AbstractMock */
    ...
    {
        $this->fixture = new phpDocumentor_Parser_AbstractMock();
    }
     ...
     * * Throws a phpDocumentor_Parser_Exception if the event dispatcher variable
