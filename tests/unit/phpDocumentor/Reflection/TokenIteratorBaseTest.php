 ...
 * @link       http://phpdoc.org
 */
class phpDocumentor_Reflection_TokenIteratorBaseTest extends PHPUnit_Framework_TestCase
{
  /** @var \phpDocumentor_Reflection_TokenIteratorBase */
  ...
  {
    $this->fixture = new \phpDocumentor_Reflection_TokenIteratorBase(array(
  ...
  public function testSeek()
  {
    ...
    $fixture2 = new phpDocumentor_Reflection_TokenIteratorBase(array_fill(0, 1000, 'a'));
...
//    $this->assertEquals(self::SERIALIZED, $this->fixture->serialize());
  ...
  {
//    $f2 = new \phpDocumentor_Reflection_TokenIteratorBase(array());
