<?php
/**
 * phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Deprecated Test
 *
 ...
 */
/**
 * Test class for phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Deprecated
 *
 * @category   phpDocumentor
 * @package    Reflection
 * @subpackage Tests
 ...
 * @copyright  Copyright (c) 2010-2011 Mike van Riel / Naenius. (http://www.naenius.com)
 */
class phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_DeprecatedTest extends PHPUnit_Framework_TestCase
{
    /**
     ...
     *
     * @covers phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Deprecated::isValid
     * @covers phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Deprecated::validateTags
    ...
    public function provideDataForIsValid()
    {
        return array(
            ...
            array(
                ...
                array(
                    'deprecated' => array(
                        'phpDocumentor_Plugin_Core_Parser_DocBlock_Validator_Deprecated' => array('deprecated')
                    )
                ),
                'File.php',
                1,
