...
/**
* Test class for phpDocumentor_Plugin_Core_Log.
*/
class phpDocumentor_Plugin_Core_LogTest extends PHPUnit_Framework_TestCase
{
  /** @var phpDocumentor_Plugin_Core_Log */
  ...
  {
    $this->assertSame('/tmp/phpDocumentor_Plugin_Core_Log_test', $this->fixture->getFilename());

    $fixture = new phpDocumentor_Plugin_Core_Log('/phpDocumentor_Plugin_Core_Log_test');
    ...
    $fixture = new phpDocumentor_Plugin_Core_Log('/tmp/phpDocumentor_Plugin_Core_Log_{DATE}');
    $this->assertStringStartsWith('/tmp/phpDocumentor_Plugin_Core_Log_'.date('YmdHi'), $fixture->getFilename());

    $fixture = new phpDocumentor_Plugin_Core_Log('{APP_ROOT}/test_log');
  ...
  {
    $this->fixture->setThreshold(phpDocumentor_Plugin_Core_Log::ALERT);
    $this->assertEquals(phpDocumentor_Plugin_Core_Log::ALERT, $this->fixture->getThreshold());

    $this->fixture->setThreshold('crit');
    $this->assertEquals(phpDocumentor_Plugin_Core_Log::CRIT, $this->fixture->getThreshold());
