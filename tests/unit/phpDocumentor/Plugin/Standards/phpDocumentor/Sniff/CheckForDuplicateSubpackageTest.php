...
/**
 * Tests for the CheckForDuplicateSubpackage class.
 */
class CheckForDuplicateSubpackageTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @var CheckForDuplicateSubpackage */
    private $fixture;
    ...
    protected function setUp()
    {
        ...
        $this->fixture = new CheckForDuplicateSubpackage(
            $this->validatorMock,
     ...
     * @covers phpDocumentor\Plugin\Standards\phpDocumentor\Sniff\CheckForDuplicateSubpackage::getConstraint
     */
    public function testIfCorrectConstraintIsPassed()
    {
        ...
        $metadataMock
            ...
            ->once()
            ->with(m::type('phpDocumentor\Plugin\Standards\phpDocumentor\Constraints\Classes\HasSingleSubpackage'));
