...
/**
 * Tests for the ReturnIsIdeDefault class.
 */
class ReturnIsIdeDefaultTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->fixture = new ReturnIsIdeDefault(
            $this->validatorMock,
     ...
     * @covers phpDocumentor\Plugin\Standards\phpDocumentor\Sniff\ReturnIsIdeDefault::getConstraint
     */
    public function testIfCorrectConstraintIsPassed()
    {
        ...
        $metadataMock
            ...
            ->with(
                m::type(
                    'phpDocumentor\Plugin\Standards\phpDocumentor\Constraints\Functions\IsReturnTypeNotAnIdeDefault'
                )
            );
