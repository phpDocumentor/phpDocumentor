...
/**
 * Tests for the CheckForDuplicatePackage class.
 */
class CheckForDuplicatePackageTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->fixture = new CheckForDuplicatePackage(
            $this->validatorMock,
     ...
     * @covers phpDocumentor\Plugin\Standards\phpDocumentor\Sniff\CheckForDuplicatePackage::getConstraint
     */
    public function testIfCorrectConstraintIsPassed()
    {
        ...
        $metadataMock
            ...
            ->once()
            ->with(m::type('phpDocumentor\Plugin\Standards\phpDocumentor\Constraints\Classes\HasSinglePackage'));
