...
/**
 * Tests for the ArgumentHasParamTag class.
 */
class ArgumentHasParamTagTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->fixture = new ArgumentHasParamTag(
            $this->validatorMock,
     ...
     * @covers phpDocumentor\Plugin\Standards\phpDocumentor\Sniff\ArgumentHasParamTag::getConstraint
     */
    public function testIfCorrectConstraintIsPassed()
    {
        ...
        $metadataMock
            ...
            ->once()
            ->with(m::type('phpDocumentor\Plugin\Standards\phpDocumentor\Constraints\Functions\IsArgumentInDocBlock'));
