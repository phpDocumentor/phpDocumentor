...
/**
 * Tests for the CheckForPackageWithSubpackage class.
 */
class CheckForPackageWithSubpackageTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @var CheckForPackageWithSubpackage */
    private $fixture;
    ...
    protected function setUp()
    {
        ...
        $this->fixture = new CheckForPackageWithSubpackage(
            $this->validatorMock,
     ...
     * @covers phpDocumentor\Plugin\Standards\phpDocumentor\Sniff\CheckForPackageWithSubpackage::getConstraint
     */
    public function testIfCorrectConstraintIsPassed()
    {
        ...
        $metadataMock
            ...
            ->once()
            ->with(
                m::type('phpDocumentor\Plugin\Standards\phpDocumentor\Constraints\Classes\HasPackageWithSubpackage')
            );
