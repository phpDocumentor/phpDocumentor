...
use phpDocumentor\DomainModel\Template\Action\Jsonp;
use phpDocumentor\DomainModel\Template\RenderPass;
use Mockery as m;
use phpDocumentor\DomainModel\Template\Parameter;

/**
 * @coversDefaultClass phpDocumentor\Renderer\Action\Jsonp
 * @covers ::<private>
 */
final class JsonpTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers ::create
    ...
    public function testExtractLogLine()
    {
        ...
        $this->assertSame('Rendered jsonp report at "1234"', (string)$command);
    }
