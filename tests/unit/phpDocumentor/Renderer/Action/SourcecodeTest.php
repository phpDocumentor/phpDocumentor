...
use phpDocumentor\DomainModel\Template\Action\Sourcecode;
use phpDocumentor\DomainModel\Template\RenderPass;
use Mockery as m;
use phpDocumentor\DomainModel\Template\Parameter;

/**
 * @coversDefaultClass phpDocumentor\Renderer\Action\Sourcecode
 * @covers ::<private>
 */
final class SourcecodeTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers ::create
    ...
    public function testExtractLogLine()
    {
        ...
        $this->assertSame('Added source code viewer at "1234"', (string)$command);
    }
