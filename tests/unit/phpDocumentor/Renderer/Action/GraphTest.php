...
use phpDocumentor\DomainModel\Template\Action\Graph;
use phpDocumentor\DomainModel\Template\RenderPass;
use Mockery as m;
use phpDocumentor\DomainModel\Template\Parameter;

/**
 * @coversDefaultClass phpDocumentor\Renderer\Action\Graph
 * @covers ::<private>
 */
final class GraphTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers ::create
    ...
    public function testExtractLogLine()
    {
        ...
        $this->assertSame('Generated the class diagram', (string)$command);
    }
