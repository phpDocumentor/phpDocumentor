...
# ADDED
 ...
 -  Add missing visibilities in (7c9cb3c8) thanks to [Mike van Riel]
 -  Add namespace and class-based templates for new default theme in (564c6a33) thanks to [Mike van Riel]
 -  Adds dockerfile for docs in (9baaec30) thanks to [Jaapio]
 -  Add Search and a lot of little features to the new template in (3bdd65f0) thanks to [Mike van Riel]
 -  Add support for 'deprecated' and test various method modifiers in (4e42536d) thanks to [Mike van Riel]
 -  Add support for Typed Properties in (7fb86476) thanks to [Mike van Riel]
 -  Add support for Version 2 configuration and make an upgrade mechanism in (7cdfa043) thanks to [Mike van Riel]
 -  Add VERSION to documentation build in (59113d67) thanks to [Mike van Riel]
 -  Allow use of 'local' templates in (946eb60b) thanks to [Mike van Riel]
 -  Cleaned up dependency versions in Composer in (9fa1a170) thanks to [Mike van Riel]
 -  Ensure Cache Folder is O/S neutral in (34f752b4) thanks to [Mike van Riel]
 -  Rework File I/O for Writers and Transformations in (688f9280) thanks to [Mike van Riel]
 -  Custom Settings may be set from command line or config in (b268f05e) thanks to [Mike van Riel]
 -  Flesh out new Class Details page in (3bfe9c15) thanks to [Mike van Riel]
 -  Improve handling of constants in new template in (ec096361) thanks to [Mike van Riel]
 -  Improve new default template in (ea09f9d8) thanks to [Mike van Riel]
 -  Improve rendering of properties in the new template in (8243a936) thanks to [Mike van Riel]
 -  Initial setup for new template in (c3e77f1a) thanks to [Mike van Riel]
 -  Introduce FlySystem into twig file loading in (dc26c750) thanks to [Mike van Riel]
 -  Introduce Symfony Config for configuration parsing in (1fed4e89) thanks to [Mike van Riel]
 -  Writers should be able to expose custom settings in (de99bea7) thanks to [Mike van Riel]
 -  Recursively upgrade configuration to newer versions in (f20e125a) thanks to [Mike van Riel]
 -  Render files as part of new template and link to them in (0eaf50e6) thanks to [Mike van Riel]


# FIXED
 -  Building an '@package' tree failed with certain characters in (73312b9b) thanks to [Mike van Riel]
 -  Clean run command docs in (29b7dc2d) thanks to [Jaapio]
 -  Clean up file header for new config in (f7aba32d) thanks to [Mike van Riel]
 -  Collections were always replaced, even when unmodified in (3a782599) thanks to [Mike van Riel]
 -  Convert v2 config to v3 and make v3 similar to previous in (3fe79641) thanks to [Mike van Riel]
 -  Allow comma-separated values for `-f` in (ca770a56) thanks to [Mike van Riel]
 -  Allow default symfony command execution in (f22ea062) thanks to [Jaapio]
 -  Allow definition of multiple api's in (c1eddd4a) thanks to [Jaapio]
 -  Allow for output folders to be set in (a75ca05d) thanks to [Mike van Riel]
 -  Allow multiple directories using comma's in (c32d5215) thanks to [Mike van Riel]
 -  Fix string class names in tests in (a8425d06) thanks to [50bhan]
 -  Configuration needed a 'phpdocumentor' root element in (358ca9d8) thanks to [Mike van Riel]
 -  Conversion of slashes causes issues instead of fixing it in (1f5e2e17) thanks to [Mike van Riel]
 -  Convert URIs into League URIs in (92d9b04c) thanks to [Mike van Riel]
 -  Dockerfil was missing && in (70ef2064) thanks to [Mike van Riel]
 -  Ensure that 'filename' and 'directory' is properly checked in (558573b1) thanks to [Mike van Riel]
 -  Ensure that the config/secrets/prod folder exists in (498b86e4) thanks to [Mike van Riel]
 -  Correctly render links to Nullable types in (8f587b84) thanks to [Mike van Riel]
 -  Merge pull request #1976 from jaapio/hotfix/docker-build in (aaf7d997) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2153 from jclaveau/more_robust_vendor_detection in (ea814901) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2165 from phpDocumentor/replace-cocur-slugify-with-symfony-string in (1b03fae1) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2193 from phpDocumentor/fix/relative-path-resolving in (f46671bc) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2196 from phpDocumentor/feature/resolve-target-path in (4e646696) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2197 from phpDocumentor/fix/windows-path-issue in (00990eab) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2202 from phpDocumentor/fix/windows-template-path-resolving in (38d28aac) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2209 from phpDocumentor/fix/2205-invalid-tags-processing in (c74065b5) thanks to [Jaap van Otterdijk]
 -  Finish configuration definition for v2 in (f5c3c4ba) thanks to [Mike van Riel]
 -  Have the Twig writer write using FlySystem in (bf44eb03) thanks to [Mike van Riel]
 -  Upgrade to Symfony 5 in (5aa85abc) thanks to [Mike van Riel
 -  Improve error message during get magic props in (f9daca10) thanks to [Jaapio]
 -  Improve error message on invalid path in (ac6f2654) thanks to [Jaapio]
 -  Create more domain specific exceptions in (106e6d56) thanks to [Jaapio]
 -  Fragments cannot be expressed in a route in (9cdc9b48) thanks to [Mike van Riel]
 -  Monolog started complaining about a setting in their latest version in (6e0573ee) thanks to [Mike van Riel]
 -  Passing "--config none" throws error in (c1ad45dd) thanks to [Mike van Riel]
 -  phpDocumentor goes into infinite loop when class extends itself in (706a84fd) thanks to [Mike van Riel]
 -  Normalize package names in (b341621b) thanks to [Mike van Riel]
 -  Links are not rendered to the correct location in (6cd8999f) thanks to [Mike van Riel]
 -  Show quotes with string values in (44a6b11c) thanks to [Mike van Riel]
...
# REMOVED
 ...
 -  Remove duplicate :bug icon in (76275110) thanks to [Jaapio]
 -  Remove duplicate entry from the build pipeline in (543f60a9) thanks to [Mike van Riel]
 -  Removed Zend Serialiser and StdLib in (9f59ab70) thanks to [Mike van Riel]
 -  Remove OS dependence on vendor folder in (f4a5773d) thanks to [Mike van Riel]
 -  Remove our own Uri object in (cb87555d) thanks to [Mike van Riel]
 -  Remove Parse and TransformCommand in (b47bc3f6) thanks to [Mike van Riel]
 -  Remove pr and lable from issue workflow in (fcedcf68) thanks to [Jaapio]
 -  Remove Type descriptors in (a3c5e83a) thanks to [Mike van Riel]
 -  Remove unused exception classes in (d1231358) thanks to [Mike van Riel]
 -  Remove unused exception classes in (e88d042b) thanks to [Mike van Riel]
 -  Remove unused function and test in (e620a3a3) thanks to [Mike van Riel]
 -  Remove unused interface in (98e1b1b9) thanks to [Mike van Riel]
 -  Remove unused property in (f583119b) thanks to [Mike van Riel]
 -  Remove unused settings, fix linting and one test in (9681c188) thanks to [Mike van Riel]
 -  Remove workaround for generating projects in other folders in (0ebf1649) thanks to [Mike van Riel]


# DOCS
 -  Ensure that all 404's are redirect to /latest in (209a8cf5) thanks to [Mike van Riel]
 -  Ensure that the docroot always goes to /latest in (481e1375) thanks to [Mike van Riel]
 -  Fixed link to Graphviz in (80280a84) thanks to [Mike van Riel]
 -  Update CONTRIBUTING.md with new branches and repo names in (4755ccef) thanks to [Mike van Riel]
 -  Update documentation on how Configuration works in (9c744197) thanks to [Mike van Riel]
 -  Update documentation template to match new style in (33363ad6) thanks to [Mike van Riel]
 -  Update README with a couple of links in (b8703d49) thanks to [Mike van Riel]
 -  Update shields in (876bbf17) thanks to [Mike van Riel]
 -  Use default nginx image and allow versioning in (4d9d4191) thanks to [Mike van Riel]
 -  Improve installation descriptions in (90b0b8c4) thanks to [Jaapio]
 -  Improve run command docs in (b6604ab0) thanks to [Jaapio]
 -  Readme update in (09a3e5e2) thanks to [Jaapio]

# CI
 - Fix some errors on PHPStan lvl 6 in (89d21e07) thanks to [Orklah]
 - Fixed indentation in (fe2cd1f2) thanks to [Graham Campbell]
 - Raised test coverage from 35% to 70% thanks to [Jaapio] & [Mike van Riel]
 - Add dependabot automerge in (9d6ecbdc) thanks to [Jaapio]
 - Add unit testing to Github Actions pipeline in (bc143f0c) thanks to [Mike van Riel]
 - Add working lables for actions and packagist in (8afda723) thanks to [Jaapio]
 - Add PHAR building to Behat PHAR tests in (6f1d6b9c) thanks to [Mike van Riel]
 - Add a quick check for code coverage in (757b0b67) thanks to [Mike van Riel]
 - Add a smoke test stage in (e0dd4341) thanks to [Mike van Riel]
 - Add initial e2e test for Default template in (e67d76dc) thanks to [Mike van Riel]
 - Add E2E tests for the Class details of Default in (bedab5cf) thanks to [Mike van Riel]
 - Add behat as binary in (632ee315) thanks to [Jaapio]
 - Add behat to execute in (7241079a) thanks to [Jaapio]
 - Add bin folder to cache in (9670f200) thanks to [Jaapio]
 - Add build matrix on unit tests in (a822d9cf) thanks to [Mike van Riel]
 - Add convenience binaries for tools in (5143d856) thanks to [Mike van Riel]
 - Add extra comment with cache key determination in (0252585e) thanks to [Mike van Riel]
 - Add make target for setting up phive and fix tests in (f2c186aa) thanks to [Mike van Riel]
 - Add missing symbols to require checker and check on pre-commit in (e558f737) thanks to [Mike van Riel]
 - Add support for testing the clean template in (50449da6) thanks to [Mike van Riel]
 - Add Symfony's var-dump-server binary to the gitignore in (4942511e) thanks to [Mike van Riel]
 - Add issue templates in (647cff5f) thanks to [Jaapio]
 - Build documentation using Github Actions in (daf93cd1) thanks to [Mike van Riel]
 - Bump phpstan to 0.12 in (3b8a2378) thanks to [Jaapio]
 - Change caching of build tools in (446e38cf) thanks to [Mike van Riel]
 - Change output folders for tests in (5440652f) thanks to [Mike van Riel]
 - Use the PHAR of PHPUnit instead of installing it globally in (81ed80c1) thanks to [Mike van Riel]
 - Enable the behat tests for all environments in (8f120950) thanks to [Mike van Riel]
 - Download tools in setup step and cache it in (24c957e3) thanks to [Mike van Riel]
 - Update issue triage workflow in (cda33a46) thanks to [Jaapio]
 - Improve build workflow with Behat tests in (96ff73e5) thanks to [Mike van Riel]
 - Switch from xdebug to pcov for Code Coverage in (463904eb) thanks to [Mike van Riel]
 - Move example project to examples and include Cypress in build in (e5c34eae) thanks to [Mike van Riel]
 - Update Cypress tests to include latest changes in the template in (fa3db1f3) thanks to [Mike van Riel]
 - Include Windows and MacOSX builds in (bc37625f) thanks to [Mike van Riel]
 - PHPStan Lvl4 in (ebe4f63b) thanks to [Mike van Riel]
 -  Merge pull request #2187 from phpDocumentor/fix/phpstan-level-5 in (f2919059) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2141 from phpDocumentor/tighten-up-coding-standards in (d1f862fa) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2134 from phpDocumentor/feature/phpunit8 in (29fe0b68) thanks to [Jaap van Otterdijk]
 -  Merge pull request #2139 from phpDocumentor/feature/php74 in (071c1667) thanks to [Jaap van Otterdijk]
 -  Simplify Behat build matrix and improve labels in (8c66b183) thanks to [Mike van Riel]
 -  Simplify Docker setup in (55ebf226) thanks to [Mike van Riel]
 -  Simplify installation of phive and add ocular in (a2434099) thanks to [Mike van Riel]
 -  Persist PHAR as artifact and re-use it where possible in (a7364d6d) thanks to [Mike van Riel]
 -  Run Cypress/E2E tests against all major O/S in (0949f3cc) thanks to [Mike van Riel]
 -  Run Cypress on 16.04 due to a bug in 18.04/Cypress 3.8.2 in (13d0bad5) thanks to [Mike van Riel]
 -  Split phpunit into a fast version and a build matrix version in (92ed69fe) thanks to [Mike van Riel]
