...
The template definition, ``template.xml``, is the starting point for every template. This is
an XML file defining which transformations need to be executed using which writers.
